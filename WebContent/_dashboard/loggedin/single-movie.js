...
function handleMovieResult(resultData) {
    ...
    if (movie_rating === 0 || movie_rating === null || movie_rating === "0.0" || movie_rating === "0"){
            movie_rating = "N/A"
    }
...
jQuery.ajax({
    ...
    url: "../../authenticated/api/single-movie?id=" + movieId, // Setting request url, which is mapped by SingleMovieServlet
