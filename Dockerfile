...
# download all the necessary software to run maven (used to compile and build the Java application) (search this maven base image in DockerHub to see what is included)
